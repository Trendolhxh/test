...
> 预估明日高能时长 **7.5h**
>
> 基于你过去 {data_days} 天的睡眠数据，{recommended_bedtime} 入睡预计能让明天的高能时间最长。拖动试试别的时间看看变化。

**调整态 — 晚睡**（用户将就寝时间拖晚于推荐）：

> 预估明日高能时长 **5.2h**
>
> 比推荐时间晚了 {delta_min} 分钟，明天高能预计少 {delta_hours} 小时。

**调整态 — 早睡**（用户将就寝时间拖早于推荐，但高能未增加）：

> 预估明日高能时长 **7.3h**
>
> 比推荐时间早了 {delta_min} 分钟，但高能没有增加——太早上床反而不容易睡着。

**调整态 — 极端时间**（睡眠时长不足 4 小时）：

> 预估明日高能时长 **2.1h**
>
> 睡眠不足 4 小时，明天的高能时间会大幅缩水。
...
**入睡提醒推送文案示例**：
- "再过半小时就是你的最佳入睡时间了，开始准备收工吧"
- "离推荐入睡时间还有 30 分钟，可以开始放下手机了"
...
| 7 | 用户选择极端时间（睡眠 < 4h） | 允许选择，文案特殊提示："睡眠不足 4 小时，明天的高能时间会大幅缩水" |
| 8 | 用户拖回推荐位置 | 恢复为推荐态文案 |
